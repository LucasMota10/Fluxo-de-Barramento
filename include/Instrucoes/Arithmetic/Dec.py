def DEC(code_base, code_limit, data_base, data_limit, cs_selector, ds_selector, ss_selector):
    """
    ...
    """
    print("\nPara a instrução DEC, informe a instrução completa no formato:")
    print("   <OFFSET_INSTRUÇÃO> DEC <DST_OFFSET>")
    print("Exemplo: 00024000 DEC 00040000")
    instr_input = input("   - Instrução: ").strip()

    # Tenta separar os componentes da linha de comando.
    try:
        # Exemplo de entrada: "00024000 DEC 00040000"
        ...
        # O segundo deve ser o mnemônico (DEC)
    ...
    registers = {
        ...
        "DST": hex(dst_offset),
        "EFLAGS": {"ZF": 0, "SF": 0, "OF": 0}  # Flags relevantes para a operação DEC
    }

    print("\n==============================================")
    print("Simulação da Execução da Instrução DEC")
    print("==============================================\n")
    ...
    # -- Etapa 4: Execução da Instrução DEC --
    print("\nEtapa 4: Execução da Instrução DEC")
    resultado = dst_data_value - 1  # Decrementa o valor em 1
    
    # Atualiza as flags com base no resultado do decremento
    ...
    print(f"   -> Resultado do Decremento: {hex(resultado)}")

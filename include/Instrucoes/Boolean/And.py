def AND(code_base, code_limit, data_base, data_limit, cs_selector, ds_selector, ss_selector):
    print("\nPara a instrução AND, informe a instrução completa no formato:")
    print("   <OFFSET_INSTRUÇÃO> AND <DST_OFFSET>, <SRC_OFFSET>")
    print("Exemplo: 00024000 AND 00040000 00081B10")
    ...
    print("\n==============================================")
    print("Simulação da Execução da Instrução AND")
    print("==============================================\n")
    ...
    print("Etapa 3: Execução da Instrução AND")
    ...
    print(" A instrução AND vai comparar cada um dos bits dos dois operandos, mantendo 1 caso ambos os bits sejam 1 e 0 se algum dos bits for 0")
